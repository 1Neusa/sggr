export default function Home() {
     return(
        <div className="flex justify-center items-center min-h-screen p-4">
                ...
                <div className="bg-black p-6 rounded-xl shadow-xl w-full max-w-md h-auto border-3 border-pink-700">
        ...
        <form action="#" method="POST" className="space-y-4">
            ...
            <div>
                <label className="block text-gray-300 mb-1 text-sm" htmlFor="nome">Nome</label>
            ...
            <div>
                <label className="block text-gray-300 mb-1 text-sm" htmlFor="senha">Senha</label>
        ...
        <p className="text-center text-gray-400 mt-4 text-xs">
            Não tem conta? <a href="#" className="text-gold hover:underline">Cadastre-se</a>
        </p>
    </div>
